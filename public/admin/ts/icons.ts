/* Admin paneli ikon seti — lucide.dev stilinde inline SVG (24x24, stroke=currentColor).
 * BottomNav.ts'teki desenle aynı: harici script/CDN yok, esbuild ile bundle'a dahil olur. */
...
/** `<i data-lucide="...">` yerine kullanılan yardımcı — SVG string + class döner. */
